          ...
          >
            <div className="sticky top-24 bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-6">
              <div className="flex items-center justify-between">
                <h3 className="font-heading font-bold text-gray-900">Filtres</h3>
                {hasActiveFilters && (
                  <button
              ...
              {/* City filter */}
              <div>
                <h4 className="text-sm font-semibold text-gray-700 mb-3">Ville / D&eacute;partement</h4>
                <Input
              ...
              {/* Rating filter */}
              <div>
                <h4 className="text-sm font-semibold text-gray-700 mb-3">Note minimum</h4>
